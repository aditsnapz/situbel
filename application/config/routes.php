...
$route['admin/slider/edit/(:any)'] = 'adminweb/Slider/edit/$id';
$route['admin/slider/add_process'] = 'adminweb/Slider/add_process';
$route['admin/slider/edit_process'] = 'adminweb/Slider/edit_process';
/* End Admin */
