...
<div class="courses2-area bg-common-style"
	style="background-image: url('<?= base_url() ?>assets/frontend/img/featured/back2.jpg');">
	<div class="container">
		...
		<div class="row courses-wrapper courses-list">
				...
				<div class="courses-box2">
					<div class="single-item-wrapper">
						<div class="courses-img-wrapper hvr-bounce-to-right">
							<img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/course/5.jpg"
								alt="courses">
							<a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
						</div>
						<div class="courses-content-wrapper">
							<h3 class="item-title"><a href="#">Evining MBA</a></h3>
							<p class="item-content">Rimply dummy texthe prinetting indus known printer galley scrambled.
							</p>
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 courses-item">
				<div class="courses-box2">
					<div class="single-item-wrapper">
						<div class="courses-img-wrapper hvr-bounce-to-right">
							<img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/course/6.jpg"
								alt="courses">
							<a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
						</div>
						<div class="courses-content-wrapper">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 courses-item">
				<div class="courses-box2">
					<div class="single-item-wrapper">
						<div class="courses-img-wrapper hvr-bounce-to-right">
							<img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/course/7.jpg"
								alt="courses">
							<a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
						</div>
						<div class="courses-content-wrapper">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 courses-item">
				<div class="courses-box2">
					<div class="single-item-wrapper">
						<div class="courses-img-wrapper hvr-bounce-to-right">
							<img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/course/8.jpg"
								alt="courses">
							<a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
						</div>
						<div class="courses-content-wrapper">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 courses-item hidden">
				<div class="courses-box2">
					<div class="single-item-wrapper">
						<div class="courses-img-wrapper hvr-bounce-to-right">
							<img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/course/9.jpg"
								alt="courses">
							<a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
						</div>
						<div class="courses-content-wrapper">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 courses-item hidden">
				<div class="courses-box2">
					<div class="single-item-wrapper">
						<div class="courses-img-wrapper hvr-bounce-to-right">
							<img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/course/10.jpg"
								alt="courses">
							<a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
						</div>
						<div class="courses-content-wrapper">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 courses-item hidden">
				<div class="courses-box2">
					<div class="single-item-wrapper">
						<div class="courses-img-wrapper hvr-bounce-to-right">
							<img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/course/11.jpg"
								alt="courses">
							<a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
						</div>
						<div class="courses-content-wrapper">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 courses-item hidden">
				<div class="courses-box2">
					<div class="single-item-wrapper">
						<div class="courses-img-wrapper hvr-bounce-to-right">
							<img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/course/12.jpg"
								alt="courses">
							<a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
						</div>
						<div class="courses-content-wrapper">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 courses-item hidden">
				<div class="courses-box2">
					<div class="single-item-wrapper">
						<div class="courses-img-wrapper hvr-bounce-to-right">
							<img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/course/13.jpg"
								alt="courses">
							<a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
						</div>
						<div class="courses-content-wrapper">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 courses-item hidden">
				<div class="courses-box2">
					<div class="single-item-wrapper">
						<div class="courses-img-wrapper hvr-bounce-to-right">
							<img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/course/14.jpg"
								alt="courses">
							<a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
						</div>
						<div class="courses-content-wrapper">
...
<div class="counter-area bg-primary-deep"
	style="background-image: url('<?= base_url() ?>assets/frontend/img/banner/4.jpg');">
	<div class="container">
		<div class="row">
	...
	<div class="container">
		<div class="rc-carousel" data-loop="true" data-items="4" data-margin="30" data-autoplay="true"
			...
			<div class="single-item">
				<div class="lecturers1-item-wrapper">
					<div class="lecturers-img-wrapper">
						<a href="#"><img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/team/1.jpg"
								alt="team"></a>
					</div>
			...
			<div class="single-item">
				<div class="lecturers1-item-wrapper">
					<div class="lecturers-img-wrapper">
						<a href="#"><img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/team/2.jpg"
								alt="team"></a>
					</div>
					<div class="lecturers-content-wrapper">
			...
			<div class="single-item">
				<div class="lecturers1-item-wrapper">
					<div class="lecturers-img-wrapper">
						<a href="#"><img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/team/3.jpg"
								alt="team"></a>
					</div>
					<div class="lecturers-content-wrapper">
			...
			<div class="single-item">
				<div class="lecturers1-item-wrapper">
					<div class="lecturers-img-wrapper">
						<a href="#"><img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/team/4.jpg"
								alt="team"></a>
					</div>
					<div class="lecturers-content-wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 news-inner-area">
				...
				<ul class="news-wrapper news-wrapper-responsive wow fadeInLeft" data-wow-duration="2s"
					data-wow-delay=".2s">
					<li>
						<div class="news-img-holder">
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/news/1.jpg"
					...
					<li>
						<div class="news-img-holder">
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/news/2.jpg"
									class="img-responsive" alt="news"></a>
						</div>
						<div class="news-content-holder">
					...
					<li>
						<div class="news-img-holder">
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/news/3.jpg"
									class="img-responsive" alt="news"></a>
						</div>
						<div class="news-content-holder">
			...
			<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 event-inner-area">
				...
				<div class="video-area2 overlay-video bg-common-style wow fadeInRight" data-wow-duration="2s"
					data-wow-delay=".2s"
					style="background-image: url('<?= base_url() ?>assets/frontend/img/banner/2.jpg');">
					<div class="video-content">
						<a class="play-btn popup-youtube" href="http://www.youtube.com/watch?v=1iIZeIy7TqM"><i
...
<div class="countdown-area bg-primary-deep-fixed"
	style="background-image: url('<?= base_url() ?>assets/frontend/img/banner/3.jpg');">
	<div class="container">
		<div class="row">
	...
	<div class="container">
		<div class="rc-carousel" data-loop="true" data-items="4" data-margin="30" data-autoplay="true"
			...
			<div class="single-item">
				<div class="single-item-wrapper">
					<div class="publications-img-wrapper">
						<a href="#"><img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/product/1.jpg"
								alt="product"></a>
					</div>
			...
			<div class="single-item">
				<div class="single-item-wrapper">
					<div class="publications-img-wrapper">
						<a href="#"><img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/product/2.jpg"
								alt="product"></a>
					</div>
					<div class="publications-content-wrapper">
			...
			<div class="single-item">
				<div class="single-item-wrapper">
					<div class="publications-img-wrapper">
						<a href="#"><img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/product/3.jpg"
								alt="product"></a>
					</div>
					<div class="publications-content-wrapper">
			...
			<div class="single-item">
				<div class="single-item-wrapper">
					<div class="publications-img-wrapper">
						<a href="#"><img class="img-responsive" src="<?= base_url() ?>assets/frontend/img/product/4.jpg"
								alt="product"></a>
					</div>
					<div class="publications-content-wrapper">
			...
			<div class="students-join3-left">
				<div id="ri-grid" class="author-banner-bg ri-grid header text-center">
					<ul class="ri-grid-list">
						<li>
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/students/student1.jpg"
									alt=""></a>
						</li>
						<li>
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/students/student2.jpg"
									alt=""></a>
						</li>
						<li>
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/students/student3.jpg"
									alt=""></a>
						</li>
						<li>
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/students/student4.jpg"
									alt=""></a>
						</li>
						<li>
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/students/student5.jpg"
									alt=""></a>
						</li>
						<li>
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/students/student6.jpg"
									alt=""></a>
						</li>
						<li>
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/students/student7.jpg"
									alt=""></a>
						</li>
						<li>
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/students/student8.jpg"
									alt=""></a>
						</li>
						<li>
							<a href="#"><img src="<?= base_url() ?>assets/frontend/img/students/student1.jpg"
