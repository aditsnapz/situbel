...
<head>
    ...
    <title>Academics | Registration</title>
...
<body>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-3">
                                <div class="logo-area">
                                    <a href="index.html"><img class="<?= base_url() ?>assets/frontend/img/-responsive" src="<?= base_url() ?>assets/frontend/img//logo-primary.png" alt="logo"></a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box">
                                <a href="index.html"><img class="<?= base_url() ?>assets/frontend/img/-responsive" src="<?= base_url() ?>assets/frontend/img//logo-footer.png" alt="logo"></a>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box">
                                ...
                                <ul class="flickr-photos">
                                    <li>
                                        <a href="#"><img class="<?= base_url() ?>assets/frontend/img/-responsive" src="<?= base_url() ?>assets/frontend/img//footer/1.jpg" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="<?= base_url() ?>assets/frontend/img/-responsive" src="<?= base_url() ?>assets/frontend/img//footer/2.jpg" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="<?= base_url() ?>assets/frontend/img/-responsive" src="<?= base_url() ?>assets/frontend/img//footer/3.jpg" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="<?= base_url() ?>assets/frontend/img/-responsive" src="<?= base_url() ?>assets/frontend/img//footer/4.jpg" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="<?= base_url() ?>assets/frontend/img/-responsive" src="<?= base_url() ?>assets/frontend/img//footer/5.jpg" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="<?= base_url() ?>assets/frontend/img/-responsive" src="<?= base_url() ?>assets/frontend/img//footer/6.jpg" alt="flickr"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <!-- Nouislider Js -->
    <script src="<?= base_url() ?>assets/frontend/vendor/noUiSlider/nouislider.min.js" type="text/javascript"></script>
    <!-- Validator js -->
    <script src="<?= base_url() ?>assets/frontend/js/validator.min.js" type="text/javascript"></script>
    <!-- Magic Popup js -->
