						...
						<form method="POST" action="<?php echo base_url('admin/tubeldn/pembayaran_add'); ?>"
								...
								<div class="modal-body">
									...
									<div class="form-group row">
										...
										<div class="col-md-10">
											<textarea type="text" name="nomor_sk" id="nomor_sk" class="form-control textarea" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-10">
											<textarea type="text" name="keterangan_biaya_admin" id="keterangan_biaya_admin" class="form-control textarea" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
										</div>
