...
<head>
	...
	<title>SITUBEL | Login Admin</title>
	<!-- favicon -->
	...
	<style type="text/css">
		body {
			...
			?>assets/gambar/background.png) !important;
	...
	<div class="login-box">
		...
		<div class="card">
			<div class="card-body login-card-body">
				<p class="login-box-msg"><strong>Selamat Datang Di Sistem Internal Admin SITUBEL</strong></p>
				<center><img src="<?= base_url('assets/gambar/Ikon-Undip.png')?>" width="50%"></center>
